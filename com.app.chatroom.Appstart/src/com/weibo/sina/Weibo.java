...
public class Weibo {
    ...
    public static String URL_USERINFO = "https://api.weibo.com/2/users/show.json";
	...
	public static void setUseruid(int useruid) {
		Weibo.useruid = useruid;
	}
...
//        activity.startActivity(i);
    ...
    public void dialog(Context context, WeiboParameters parameters,
        ...
        if (context.checkCallingOrSelfPermission(Manifest.permission.INTERNET) != PackageManager.PERMISSION_GRANTED) {
          ...
          AuthorizeActivity.dialog  =  new WeiboDialog(this, context, url, listener);
          AuthorizeActivity.dialog.show();
        }
    }
