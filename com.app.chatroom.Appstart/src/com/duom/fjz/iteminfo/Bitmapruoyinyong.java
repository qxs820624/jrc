...
public class Bitmapruoyinyong {

	static private Bitmapruoyinyong cache;
	...
	public static Bitmapruoyinyong getInstance() {

		if (cache == null) {

			cache = new Bitmapruoyinyong();
