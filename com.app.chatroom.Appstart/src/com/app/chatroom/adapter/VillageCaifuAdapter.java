...
public class VillageCaifuAdapter extends BaseAdapter {
	...
	public VillageCaifuAdapter(VillageActivity c,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = li.inflate(R.layout.village_caifu, null);
			...
			viewHolder.userLevelImage = (RelativeLayout) convertView
					.findViewById(R.id.village_caifu_imageView);
			viewHolder.userLevelText = (TextView) convertView
					.findViewById(R.id.village_level_textView);
			viewHolder.caifuiv = (ImageView) convertView
					.findViewById(R.id.village_caifu_imageView2);
			viewHolder.caifuno = (TextView) convertView
					.findViewById(R.id.caifu_no_TextView);
			viewHolder.userdengji = (TextView) convertView
					.findViewById(R.id.village_caifu_textView);
		...
		switch (position) {
		case 0:
			viewHolder.caifuiv.setBackgroundDrawable(context
					.getResources().getDrawable(R.drawable.caifu1));
			 viewHolder.userLevelImage.setVisibility(View.GONE);
	         viewHolder.userdengji.setVisibility(View.GONE);
	         viewHolder.caifuno.setVisibility(View.VISIBLE);
			break;
		case 1:
			viewHolder.caifuiv.setBackgroundDrawable(context
					.getResources().getDrawable(R.drawable.caifu2));
			 viewHolder.userLevelImage.setVisibility(View.GONE);
	         viewHolder.userdengji.setVisibility(View.GONE);
	         viewHolder.caifuno.setVisibility(View.VISIBLE);
			break;
		case 2:
			viewHolder.caifuiv.setBackgroundDrawable(context
					.getResources().getDrawable(R.drawable.caifu3));
			 viewHolder.userLevelImage.setVisibility(View.GONE);
	         viewHolder.userdengji.setVisibility(View.GONE);
	         viewHolder.caifuno.setVisibility(View.VISIBLE);
			break;
		default:
			viewHolder.caifuiv.setBackgroundDrawable(context
					.getResources().getDrawable(R.drawable.caifu4));
