 ...
 * 
 */
public class DownFileRight {

	private ArrayList<String> urls = new ArrayList<String>();

	public DownFileRight() {
		// TODO Auto-generated constructor stub
	}

	public void down(String url, String path, String path2, ProgressBar progerss) {
		loadFile(url, path, path2, progerss);
	}
	...
	public void loadFile(String url, String path, String path2,
		...
		if (!isLocal(url, path, path2)) {
			...
			if (SystemUtil.getSDCardMount()) {
				new DownLoadFile(progerss).execute(url, path);
			} else {
				new DownLoadFile(progerss).execute(url, path2);
			}
		} else {
