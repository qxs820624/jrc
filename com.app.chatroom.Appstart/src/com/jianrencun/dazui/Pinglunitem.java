...
public class Pinglunitem {
	...
	public Pinglunitem(int id, int uid, String unick, String uhead,
			String date, String afile, String pfile, String desc, String desc_c , int type ,int alen, boolean isbdh ,String nameclor , int aflg , int pid , String numofdiscuss , int touxiangbj ) {
		super();
		this.id = id;
		this.uid = uid;
		this.unick = unick;
	...
	public Pinglunitem(int id, int uid, String unick, String uhead,
			String date, String afile, String pfile, String desc, String desc_c , int type ,int alen, boolean isbdh ,String nameclor , int aflg , int pid , String numofdiscuss , int touxiangbj ,  String jubaolink) {
		super();
		this.id = id;
		this.uid = uid;
		this.unick = unick;
